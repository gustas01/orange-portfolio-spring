...
public class TestUtilsMocks {
  ...
  public CreateProjectDTO mockCreateProjectDTO2 = new CreateProjectDTO("Um outro título de projeto", "Uma outra descrição de projeto", "http://www.umaoutraurldeprojeto.com.br");
