...
public class TestUtilsMocks {
  ...
  public static Tag mockTag = new Tag(1, "backend", List.of(), true);
  public static List<Tag> mockTags = List.of(mockTag);
  public static Project mockProject = new Project(UUID.fromString("c9d7c521-5e4c-4e2a-b604-dac3d11bb5c0"), "Um título de projeto", "Uma descrição de projeto", "http://www.umaurldeprojeto.com.br", "http://www.umaurldethumbnaildeprojeto.com.br", LocalDateTime.now(), mockUser, Set.of(mockTag));
  public static ProjectDTO mockProjectDTO = new ProjectDTO(UUID.fromString("c9d7c521-5e4c-4e2a-b604-dac3d11bb5c0"), "Um título de projeto", "Uma descrição de projeto", "http://www.umaurldeprojeto.com.br", "http://www.umaurldethumbnaildeprojeto.com.br", LocalDateTime.now(), Set.of(mockTag));
}
